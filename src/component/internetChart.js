      ...
      <>
        <div className='cytsocapteContainer'>
          <div className="ct-btn-container">
            ...
            <button id="draw-on" onClick={drawOn}>Draw mode on</button>
            <button id="draw-off" onClick={drawOff}>Draw mode off</button>
          </div>
          <CytoscapeComponent elements={[]} style={ { width: '100%', height: '400px'} } 
            ...
            cy={(cy) => { cy1 = cy; cy.contextMenus(options); eh = cy.edgehandles(defaults); console.log('cyto')}} ref={ref}/>
